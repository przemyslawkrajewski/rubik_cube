...
if __name__ == '__main__':
	env, robot = openrave_irp6.initialize(manageIrpos=True)
	print "Done"
	...
	robot.track.moveToCartesianPosition(Pose(Point(0.00904485399, 1.30059724452807, 1.20842285353), Quaternion(-0.000379723678393, -0.999880665371, 0.00120047894583, 0.0153970671608)),simulate=False)
